...
| `fetch_hicp_index_bg` | `geo=BG&unit=I15&sinceTimePeriod=2020-01` | `I15` keeps the 2015=100 base; `transform.rebase_index_to_2020` normalises it, so I15 vs the official I25 is immaterial. |
...
| **Eurostat retires the I15 base** | ver.2's official base is 2025=100 (`I25`); `I15` is a recalculated back-series | Switch `unit=I15` → `I25` in `fetch_hicp_index_bg`. Nothing else changes — `rebase_index_to_2020` normalises whatever base arrives. |
