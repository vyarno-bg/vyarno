  ...
  <ol>
    <li>
      <span class="l-bg"
        ...
        Евростат. Ние само го претегляме с това, колко от парите си даваш за групата.
        <i>Пример:</i>
        ...
        менят само дяловете - поскъпванията са на Евростат и не ги пипаме.</span
      >
      <span class="l-en"
    ...
    <li>
      ...
      <span class="l-bg"
        ...
        обичайната за банките равна месечна вноска върху кредит от {fmt0(100 - downPayPct)}% от
        цената (останалите {fmt0(downPayPct)}% са самоучастие), с твоята лихва и твоя срок.</span
      >
      <span class="l-en"
