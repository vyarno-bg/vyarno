...
|---|---|---|
| `pytest` в `pipeline/` | без интернет | Конекторите, преобразуванията, шестте проверки, публикуваните файлове |
...
собствен адрес, а не част от правната страница, за да може да се посочи.
