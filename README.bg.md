...
| **НСИ** | средната работна заплата във всяка от 28-те области — една от тях е нивото, по което е изравнена подредбата на заплатите — и средната работна заплата по икономически дейности, 19 раздела по КИД-2008, с имената на самите НСИ |
